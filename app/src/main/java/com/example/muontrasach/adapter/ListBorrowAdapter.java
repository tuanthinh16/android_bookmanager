...
public class ListBorrowAdapter extends RecyclerView.Adapter<ListBorrowAdapter.ViewHolder>  {
    ...
    public ListBorrowAdapter(Context mContext, onClickItem listener) {
    ...
    @NonNull
    @Override
    public ListBorrowAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.borrow_item, null);
        RecyclerView.LayoutParams lp = new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);

        inflate.setLayoutParams(lp);
        return new ListBorrowAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull ListBorrowAdapter.ViewHolder holder, int position) {
